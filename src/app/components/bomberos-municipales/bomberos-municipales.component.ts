...
@Component({
  selector: 'app-bomberos-municipales',
  templateUrl: './bomberos-municipales.component.html',
  styleUrls: ['./bomberos-municipales.component.css']
})
export class BomberosMunicipalesComponent implements OnInit {
  map: any;
