...
@Component({
  selector: 'app-policia-nacional',
  templateUrl: './policia-nacional.component.html',
  styleUrls: ['./policia-nacional.component.css']
})
export class PoliciaNacionalComponent implements OnInit {
  map: any;
